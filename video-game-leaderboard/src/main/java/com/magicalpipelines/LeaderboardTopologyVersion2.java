...
class LeaderboardTopologyVersion2 {
        ...
        public static Topology build() {
                ...
                KStream<String, ScoreWithPlayer> withPlayers = scoreEvents.join(players, scorePlayerJoiner,
                                playerJoinParams);
                ...
                // alternatively, use the following if you want to name the grouped repartition
                // topic:
                ...
                /**
                 * The logic for aggregating high scores is implemented in the HighScores.add
                 * method
                 */
                Aggregator<String, Enriched, HighScores> highScoresAdder = (key, value, aggregate) -> aggregate
                                .add(value);
